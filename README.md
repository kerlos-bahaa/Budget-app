...
[presentation](https://drive.google.com/file/d/177IwKgxcF-OxAFTBpnq_MGsg1lpg7irO/view?usp=sharing)
...
- Clone the project to your directory by running
  https://github.com/kerlos-bahaa/Budget-app
- Run the code with ruby

Example commands:

```sh
  git clone https://github.com/kerlos-bahaa/Budget-app
```
...
Feel free to check the [issues page](https://github.com/kerlos-bahaa/Budget-app/issues).
